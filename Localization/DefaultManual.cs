...
namespace TextureGrade.Localization
{
    ...
    public static class DefaultManual
    {
        ...
        private static string ZhCn() => new StringBuilder()
            ...
            .AppendLine("· 左下工具按「视图 / 选择 / 顶点同步」分组。选面与平移是独立按钮，蓝色表示当前模式。大量顶点以合并标记显示，选择数据与发送顶点不减少。")
            ...
            .AppendLine("· 左下「视图」栏的「隐藏 UV / 显示 UV」切换线框和顶点标记，并与顶部菜单同步；选区及调色结果保留。")
        ...
        private static string ZhTw() => new StringBuilder()
            ...
            .AppendLine("· 左下工具依「檢視 / 選取 / 頂點同步」分組。選面與平移為獨立按鈕，藍色表示目前模式。大量頂點以合併標記顯示，不減少選取資料或傳送頂點。")
            ...
            .AppendLine("· 左下「檢視」欄的「隱藏 UV / 顯示 UV」切換線框和頂點標記，並與頂端選單同步；選取範圍及調色結果保留。")
        ...
        private static string En() => new StringBuilder()
            ...
            .AppendLine("- Lower-left tools are grouped as View / Selection / Vertices. Select and Pan have separate buttons; blue indicates the active mode. Dense display marks are combined without reducing selected or sent vertices.")
            ...
            .AppendLine("- Hide UV / Show UV in the lower-left View tools toggles wireframes and vertex markers, synchronized with the top menu. Selection and graded pixels are preserved.")
        ...
        private static string Ja() => new StringBuilder()
            ...
            .AppendLine("· 左下のツールは表示 / 選択 / 頂点同期に分類されています。選択と平移は独立したボタンで、青色が現在のモードです。密集した表示マークは統合しますが、選択や送信する頂点は減らしません。")
            ...
            .AppendLine("· 左下の表示ツールの「UV を隠す / UV を表示」で線と頂点マーカーを切り替え、上部メニューと同期します。選択範囲と調色結果は保持されます。")
